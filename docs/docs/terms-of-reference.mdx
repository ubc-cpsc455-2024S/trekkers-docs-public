...
A PDF verison of this documentation is available [here](/files/Trek-Terms-of-Reference.pdf).
...
1. **Inclusivity**: Encourage and support contributions from all team members, regardless of their level of experience or background.
2. **Respect**: Respect differing viewpoints and experiences. Provide constructive feedback and be open to receiving it.
3. **Patience**: Recognize that everyone is learning. Offer help and guidance, and be patient with those who may need more time to understand.
4. **Collaborative**: Work together to solve problems and achieve our project goals. Share knowledge and resources freely.
5. **Kindness**: Show empathy and kindness to all team members. Celebrate successes and provide support during challenges.
6. **Transparency**: Communicate openly and honestly. Share your progress, challenges, and decisions with the team to maintain trust and clarity.