...
:::tip
A **PDF version** of the Terms of Reference document is available [here](/files/Trekkers_Terms_of_Reference_2024-05-29.pdf).
:::
...
| Complete Front-end Development | Complete frontend development of the web app without API hook-up                              | May 30th, 2024 to June 8th, 2024 |
...
The documentation of this project will be released in the schedule and format mentioned below. There is no formal requirement for documentation with respect to the CPSC 455 course with exception to the Work-In-Progress Scrum reports.

| Document                           | Format     | Expected Release Date |
|------------------------------------|------------|-----------------------|
| Terms of Reference                 | PDF, web   | May 28th, 2024        |
| Project Plan                       | PDF, web   | May 29th, 2024        |
| Business Requirements              | PDF, web   | May 29th, 2024        |
| Technical Design                   | PDF, web   | May 29th, 2024        |
| Testing Plan                       | PDF, web   | June 15th, 2024       |
| Deployment Guide                   | PDF, web   | July 31st, 2024       |
| Work-In-Progress Report (Scrum)    | web        | Every two weeks       |
| Pre-Release Notes                  | web        | Every week            |
| 1.0.0 Release Note                 | web        | August 5th, 2024      |
